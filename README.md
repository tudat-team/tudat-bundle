...
6. Install Tudat and TudatPy

This will let conda know that Tudat and TudatPy exist, even if they have not been compiled yet, and it is required in order to generate tudatpy's stubs.
```
python install.py
```
